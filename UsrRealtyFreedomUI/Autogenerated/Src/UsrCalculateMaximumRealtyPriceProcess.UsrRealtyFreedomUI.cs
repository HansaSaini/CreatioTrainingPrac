namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateMaximumRealtyPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalculateMaximumRealtyPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalculateMaximumRealtyPriceProcessMethodsWrapper(Process process)
			: base(process) {
